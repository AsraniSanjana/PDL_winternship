# ref: https://youtu.be/tTo0dmgzrFI?feature=shared
# using mediapipe instead of tflite-support.
import argparse
import sys
import time
import cv2
...
#  cap = cv2.VideoCapture(camera_id)
  ...
  # base_options = python.BaseOptions(file_name=model, use_coral=enable_edgetpu, num_threads=num_threads)
